...
///
/// Neden gerekli:
///   - <see cref="Path.GetInvalidFileNameChars"/> platform bağımlıdır (macOS/Linux'ta neredeyse
...
public sealed class SafeFileName
{
    ...
    /// <summary>Adı geçerli bir dosya adına indirger (çakışma yönetimi yok).</summary>
    ...
    /// <summary>Çakışmayı çözmeye yetecek kadar kısa, deterministik hash (8 hex).</summary>
